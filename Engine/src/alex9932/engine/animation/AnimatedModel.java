...
public class AnimatedModel {
	...
	private AnimatedModelData entityData;
	 ...
	 * 
	 */
	public AnimatedModel(AnimatedModelData entityData, Vao model, Texture texture, Joint rootJoint, int jointCount) {
		this.model = model;
	...
	public AnimatedModelData getEntityData() {
		return entityData;
	}
