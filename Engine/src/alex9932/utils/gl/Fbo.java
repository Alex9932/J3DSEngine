...
public class Fbo {
	public static final int FBO_DEFAULT = 0x00;
	public static final int FBO_MULTISAMPLED = 0x01;
	...
	public Fbo(Display display, int width, int height) {
		this(display, width, height, FBO_DEFAULT, 1);
	}
	...
	private void createBuffer() {
		...
		if(this.type == FBO_MULTISAMPLED){
			...
			renderedBuffer = GL30.glGenRenderbuffers();
			...
			GL30.glFramebufferRenderbuffer(GL30.GL_FRAMEBUFFER, GL30.GL_COLOR_ATTACHMENT0, GL30.GL_RENDERBUFFER, renderedBuffer);
